...
You get started with Run transform plugin by building directly from the latest source code::
   ...
   git clone git@github.com:hydrator/dynamodb-sink.git
   cd dynamodb-sink
   mvn clean package
...
You can deploy a plugin using the CDAP CLI::
  ...
  > load artifact target/dynamodb-sink-plugin-<version>.jar \
         config-file target/dynamodb-sink-plugin-<version>.json
